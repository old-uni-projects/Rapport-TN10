...
\fancyhead[L]{\includegraphics[width=3cm]{valeo.jpg}}
\fancyhead[R]{\includegraphics[width=3cm]{utc.jpg}}
\fancyhead[C]{Rapport de stage TN09 - Jonathan DEKHTIAR\\}
...
\include{Parties/Valeo}

\include{Parties/Stage}

\chapter{Le Cloud Computing}
\input{Parties/Cloud/Cloud-1}
\input{Parties/Cloud/Cloud-2}
\clearpage
...
\input{Parties/Cordys/Cordys-1}
\input{Parties/Cordys/Cordys-2}
\input{Parties/Cordys/Cordys-3}
\clearpage
