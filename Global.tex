...
\include{Parties/DeltaCAD}

\include{Parties/Stage}

\include{Parties/Metis}

\chapter{La Reconnaissance de formes.}
\input{Parties/ShapeMatching}

\chapter{L'Apprentissage Automatique.}
\input{Parties/MachineLearning}

\clearpage

\chapter{Les Shock Graphs}
\input{Parties/ShockGraphs}
\clearpage

\chapter{Shape Learner - Plugin METIS}
\input{Parties/ShapeLearner/ShapeLearner-1}
\input{Parties/ShapeLearner/ShapeLearner-2}
\input{Parties/ShapeLearner/ShapeLearner-3}
\input{Parties/ShapeLearner/ShapeLearner-4}
\input{Parties/ShapeLearner/ShapeLearner-5}
\clearpage
